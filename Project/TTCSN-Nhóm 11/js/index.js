...
function addToCart(add_cart_btn) {
    ...
    add_cart_btn.addEventListener('click', (e) => {
        ...
        var cart_ct = document.querySelectorAll(".cart-content");
        product_cart_quantity(cart_ct);
        var cart_del_all = document.querySelectorAll(".cart-del");
        cart_remove(cart_del_all);
...
var cart_pro_quantity = document.querySelector(".cart-pro-quantity");
...
function product_cart_quantity(event) {
    cart_pro_quantity.innerHTML = event.length;
}